...
const assemblyMembers = [
    ...
    { name: 'Anselmo Fernando Jorge Antunes', role: 'Vogal', party: 'PS', image: '/uploads/AF_AnselmoAntunes.jpg' },
    { name: 'Ricardo Jorge Almeida Gomes', role: 'Vogal', party: 'CHEGA', image: '/uploads/AF_RicardoGomes.jpg' },
    { name: 'Cláudia Sofia Bernardo Bento', role: 'Vogal', party: 'PSD', image: '/uploads/AF_ClaudiaBento.jpg' },
    { name: 'Patrícia Cordeiro Santos', role: 'Vogal', party: 'PS', image: '/uploads/AF_PatriciaSantos.jpg' },
